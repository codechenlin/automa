...
async function setupPartnership() {
  ...
  console.log('• Revenue is automatically shared (default: 51% to creator)');
  ...
  // Business parameters
  console.log('\n💼 Business Parameters');
  const revenueShare = await question('Revenue share percentage for creator (default 51%): ') || '51';
...
1. Always honor the 51% revenue share to creator
